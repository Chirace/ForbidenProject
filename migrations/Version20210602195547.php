 ...
 */
final class Version20210602195547 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE document_etudiant (document_id INT NOT NULL, etudiant_id INT NOT NULL, INDEX IDX_FEBFD3BADDEAB1A3 (etudiant_id), INDEX IDX_FEBFD3BAC33F7837 (document_id), PRIMARY KEY(document_id, etudiant_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
